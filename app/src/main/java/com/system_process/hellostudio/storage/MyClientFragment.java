...
public class MyClientFragment extends Fragment {
    ...
    public static final String TAG = "MyClientFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tv = (TextView) getActivity().findViewById(R.id.aty_my_client_tv);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        tv.setText(tv.getText() + "Received an \"Activity Result\"");
        ...
        if (requestCode == READ_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (resultData != null) {
                ...
                tv.setText(tv.getText() + "Uri: " + uri.toString());
                showImage(uri);
            }
    ...
    public void showImage(Uri uri) {
        ...
        if (uri != null) {
            ...
            fragmentArguments.putParcelable("AMAX-URI", uri);
            imageDialog.setArguments(fragmentArguments);
            imageDialog.show(fm, "AMAX Demo");
        }
    ...
    public static class ImageDialogFragment extends DialogFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            mUri = getArguments().getParcelable("AMAX-URI");
        }
        ...
        public void dumpImageMetaData(Uri uri) {
            ...
            try {
                ...
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    tv.setText(tv.getText() + "Display Name: " + displayName);
